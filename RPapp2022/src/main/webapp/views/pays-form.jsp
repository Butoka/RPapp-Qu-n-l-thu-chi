                    ...
                    <!-- Check username -->
                      ...
                      <form class="mt-3" method="post" action="" ${message!=null?'hidden':''}>
                              ...
                              <div class="row">
                                  ...
                                  <div class="col-md-12">
                                    <div class="input-group input-group-outline my-2">
                                      ...
                                      <input type="text" class="form-control" name="name" value="${pay.name}" required="required">
                                    </div>
                                    <!-- Check username -->
                                  ...
                                  <div class="col-md-12">
                                    <div class="input-group input-group-outline my-2">
                                      ...
                                      <input min="0" type="number" class="form-control" name="money" value='${pay.money}'  required="required">
                                    </div>
                                    <!-- Check username -->
			                        <div class="text-danger mb-2" role="alert" ${!m1?'hidden':''}>
			                          <small>${message1}</small>
                                    ...
                                    <div class="input-group input-group-static mb-4">
									     ...
									     <select name="cate" class="form-control" id="exampleFormControlSelect1">
									      <c:forEach var="item3" items="${cate}">
									      		 <option ${pay.category.id==item3.id?'selected':''} value="${item3.id}">${item3.name}</option>
									      </c:forEach>
									     </select>
									   </div>
                                  </div>
                              ...
                              <div class="row p-3 justify-content-end">
                              	<button ${re?'hidden':''} class="col-md-2 btn btn-icon btn-2 btn-success" type="submit" formaction="/RPapp2022/pays-form/update">
                                  <span class="btn-inner--icon"><i class="material-icons mb-1">save</i></span>
                                  <span class="btn-inner--text">Cập nhật</span>
                                </button>
                                <button ${re?'':'hidden'} class="col-md-2 btn btn-icon btn-2 btn-success" type="submit" formaction="/RPapp2022/pays-form/add">
                                  <span class="btn-inner--icon"><i class="material-icons mb-1">save</i></span>
                                  <span class="btn-inner--text">Thêm</span>
                                </button>
                                <button ${re?'hidden':''} class="col-md-2 btn btn-icon btn-2 btn-danger" type="submit" formaction="/RPapp2022/pays-form/delete">
                                  <span class="btn-inner--icon"><i class="material-icons mb-1">highlight_off
                                  </i></span>
                                  <span class="btn-inner--text">Xóa</span>
                                </button>
                                <a class="ms-1 col-md-2 btn btn-icon btn-2 btn-secondary" href="/RPapp2022/pays-form">
